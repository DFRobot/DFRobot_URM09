...
void setup() {
  ...
  URM09.SetModeRange(MEASURE_MODE_AUTOMATIC ,MEASURE_RANG_500);   // The module is configured in automatic mode and the ranging range is set to 500cm
  delay(100);
}
